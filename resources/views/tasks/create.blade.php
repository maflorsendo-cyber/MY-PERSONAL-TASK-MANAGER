    ...
    <div class="card border-0 shadow-lg rounded-4 bg-white overflow-hidden">
        <div class="p-4 p-md-5 text-white" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%);">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h3 class="fw-bold mb-1">Create New Task</h3>
                    <p class="text-white-50 small mb-0">Organize your daily activities effectively.</p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ url('/tasks') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control bg-light border-start-0 py-2.5 @error('task_name') is-invalid @enderror" id="task_name" name="task_name" value="{{ old('task_name') }}" placeholder="e.g., Review for upcoming exams" required>
                    </div>
                    @error('task_name')
                ...
                <!-- Description -->
                <div class="mb-4">
                    <label for="description" class="form-label fw-bold text-dark small text-uppercase">Description (Optional)</label>
                    <textarea class="form-control bg-light py-2.5" id="description" name="description" rows="4" placeholder="Add some details about this task...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" class="form-control bg-light border-start-0 py-2.5" id="due_date" name="due_date" value="{{ old('due_date') }}">
                    </div>
                </div>
